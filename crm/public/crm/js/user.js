layui.config({
    ...
    table.render({
        ...
        cols: [[
            ...
            { field: 'user_name', title: '客户名', width: 120 },
            ...
            { field: 'user_desc', title: '详细地址', width: 220, },
            { field: 'user_type', title: '客户类型', width: 120, },
            { field: 'user_source', title: '客户来源', width: 220, },
            { field: 'admin_id', title: '添加人', width: 120, },
            { field: 'user_ctime', title: '添加时间', width: 220, },
            { field: 'user_company', title: '公司名称', width: 120, },
