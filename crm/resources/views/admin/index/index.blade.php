...
<head>
    ...
    <link href="crm/lib/animate/animate.min.css" rel="stylesheet" />
    ...
    <style>
        body {
            ...
            background-image: url(crm/images/bg_01.jpg);
        }
    </style>
</head>
<body>
                ...
                <div class="winui-nav-tile">
                    ...
                    <div class="winui-tilebox">
                        ...
                        <div class="winui-tilebox-body">
                            ...
                            <div class="winui-tile winui-tile-normal">
                                <img src="crm/images/logo_100.png" />
                                <span>自定义图片</span>
                            </div>
                            <div class="winui-tile winui-tile-normal">
                                <i class="fa fa-file-text"></i>
                            ...
                            <div class="winui-tile winui-tile-normal">
                                <img src="crm/images/qzone_32.png" />
                                <span>QQ空间</span>
                            </div>
                            <div class="winui-tile winui-tile-normal">
